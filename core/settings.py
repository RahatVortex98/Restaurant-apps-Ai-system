...
SECURE_BROWSER_XSS_FILTER = True if os.getenv("SECURE_BROWSER_XSS_FILTER") =='True' else False
SECURE_CONTENT_TYPE_NOSNIFF = True if os.getenv("SECURE_CONTENT_TYPE_NOSNIFF") =='True' else False
